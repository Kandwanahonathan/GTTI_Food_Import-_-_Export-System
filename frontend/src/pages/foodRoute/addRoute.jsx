    ...
    return(
        <div className='bg-gray-200 min-h-screen flex justify-center items-center' >
            <div className='bg-white w-[900px] p-6 rounded-lg shadow-lg'>
                <h1 className='text-center text-blue-900 font-bold text-2xl'>ADD FOOD OF COMPANY</h1>
                <div className='flex flex-col gap-4'>
                    ...
                    <button onClick={()=>{
                         handleAdd()
                        navigate('/foodSelect')
                        }} className='bg-blue-500 text-white font-bold p-2 rounded hover:bg-blue-700 transition duration-900'>ADD FOOD</button>
                </div>
            </div>
        </div>
    )
